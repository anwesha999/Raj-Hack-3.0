...
if (!isset($_SESSION["type"])=="admin") {header ("location:index.php");}
...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Add New Product || CoDerZ_By_Nature</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">CoDerZ_By_Nature</a></h1>
        </li>
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Nayan" name="pname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Seth" name="desc">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="file" id="right-label" placeholder="Infinite Loop" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em;">&copy; CoDerZ_By_Nature for Rajasthan Digifest 3.0</p>
        </footer>
...
if($mysqli->query("INSERT INTO users (fname, lname, address, city, pin, email, password) VALUES('$fname', '$lname', '$address', '$city', $pin, '$email', '$pwd')")){
	echo '<script>Data inserted</script>';
		...
		echo '<script>There was some error..!!</script>';
}
